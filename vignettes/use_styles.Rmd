...
-10L))
data <- dplyr::mutate(data, name = stringr::str_wrap(name, 10))
...
Podemos seleccionar alguna variante inspirada en sus obras. En el caso de Monet, las opciones de `work_inspired_by` son: **water_lilies**, **impression_sunrise** y **poppy_fields**
...
```{r}
style_da_vinci(data, "name", "paintings", plot_type = "column", add_glow = T, add_grid_lines = T)
```
