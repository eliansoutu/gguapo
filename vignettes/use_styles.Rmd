...
- `add_texture` aplica a gráficos de columnas, le agrega textura al relleno simulando pinceladas. Hay tres opciones (1 al 3), No funciona con fill_var.
...
- `add_filter` es aún muy experimental, puede demorar unos segundos en cargar. Aplica un filtro estilo pintura al gráfico entero, generando márgenes indeseados. e sugiere aumentar el `text_size` para mejorar la visual de los textos.
