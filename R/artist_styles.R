...
style_da_vinci <- function(data, x, y, color_var = NULL, fill_var = NULL,
  ...
  # Apply dynamic color/fill scales
  ...
  if (show_labels) {
    if (plot_type == "column") {
      p <- p + ggplot2::geom_text(ggplot2::aes_string(label = y), vjust = -0.5, hjust = 0.5,
                                  size = 3.5, color = settings$text_color, family = settings$font_body)
    } else {
      p <- p + ggrepel::geom_text_repel(ggplot2::aes_string(label = y), size = 3.5, box.padding = 0.5, min.segment.length = 0.3,
  ...
  p + ggplot2::theme_void() +
    ggplot2::theme(
      ...
      axis.text = ggplot2::element_text(size = 12, color = settings$text_color, family = settings$font_body),
      axis.title = ggtext::element_markdown(size = 15, color = settings$text_color, family = settings$font_body),
      panel.grid.major = if (add_grid_lines) ggplot2::element_line(color = settings$grid_color, linetype = "dotted", linewidth = 0.3) else ggplot2::element_blank(),
    ...
    ggplot2::labs(
      ...
      x = paste0("<span style='font-family:\"", settings$font_body, "\";'>", tools::toTitleCase(gsub("_", " ", x)), "</span>"),
      y = paste0("<span style='font-family:\"", settings$font_body, "\";'>", tools::toTitleCase(gsub("_", " ", y)), "</span>")
    )
}
...
#' @importFrom grDevices colorRampPalette
#' @export
style_michelangelo <- function(data, x, y, color_var = NULL, fill_var = NULL,
  ...
  p + ggplot2::theme_minimal() +
    ggplot2::theme(
      ...
      axis.text = ggplot2::element_text(size = 12, color = settings$text_color, family = settings$font_body),
      axis.title = ggtext::element_markdown(size = 15, color = settings$text_color, family = settings$font_body),
      panel.grid.major = if (add_grid_lines) ggplot2::element_line(color = settings$grid_color, linetype = "solid", linewidth = 0.3) else ggplot2::element_blank(),
      panel.grid.minor = ggplot2::element_blank(),
      axis.line = ggplot2::element_line(color = settings$grid_color, linewidth = 0.5)
    ) +
    ggplot2::labs(
      title = paste0("<span style='font-family:\"", settings$font_title, "\";'>", title, "</span>"),
      subtitle = paste0("<span style='font-family:\"", settings$font_body, "\";'>", subtitle, "</span>"),
...
# 3. Estilo Rembrandt
# Inspiración: Claroscuro, tonos oscuros, dorados, detalles en la luz.
...
#' @importFrom grDevices colorRampPalette
#' @export
style_rembrandt <- function(data, x, y, color_var = NULL, fill_var = NULL,
  ...
  settings <- list(
    "night_watch" = list(
      ...
      background_fill = "#2F2F2F", panel_fill = "#3A3A3A",
  ...
  p + ggplot2::theme_dark() +
    ggplot2::theme(
      ...
      axis.text = ggplot2::element_text(size = 12, color = settings$text_color, family = settings$font_body),
      axis.title = ggtext::element_markdown(size = 15, color = settings$text_color, family = settings$font_body),
      panel.grid.major = if (add_grid_lines) ggplot2::element_line(color = settings$grid_color, linetype = "dotted", linewidth = 0.4) else ggplot2::element_blank(),
      panel.grid.minor = ggplot2::element_blank(),
      axis.line = ggplot2::element_line(color = settings$grid_color, linewidth = 0.5)
    ) +
    ggplot2::labs(
...
# 4. Estilo Vincent van Gogh
# Inspiración: Pinceladas audaces, colores vibrantes, texturas, espirales.
...
#' @param show_labels Logical, whether to show data labels. Defaults to FALSE.
#' @param add_glow Logical, whether to add an outer glow effect. Defaults to FALSE.
#' @param add_texture Logical, whether to add texture (density contours) to scatter plots. Defaults to FALSE.
#' @param add_grid_lines Logical, whether to show major grid lines. Defaults to FALSE.
#' @param show_background Logical, whether to show the panel background. Defaults to FALSE.
#' @return A ggplot2 object.
...
#' @importFrom grDevices colorRampPalette
#' @export
style_van_gogh <- function(data, x, y, color_var = NULL, fill_var = NULL,
  ...
  settings <- list(
    "starry_night" = list(
      ...
      font_title = "Playfair Display", font_body = "Roboto Condensed",
      background_fill = "#1A2A50", panel_fill = "#1A2A50",
  ...
  p + ggplot2::theme_dark() +
    ggplot2::theme(
      ...
      axis.text = ggplot2::element_text(size = 12, color = settings$text_color, family = settings$font_body),
      axis.title = ggtext::element_markdown(size = 15, color = settings$text_color, family = settings$font_body),
      panel.grid.major = if (add_grid_lines) ggplot2::element_line(color = settings$grid_color, linetype = "dotted", linewidth = 0.5) else ggplot2::element_blank(),
      panel.grid.minor = ggplot2::element_blank(),
      axis.line = ggplot2::element_line(color = settings$grid_color, linewidth = 0.8)
    ) +
    ggplot2::labs(
      title = paste0("<span style='font-family:\"", settings$font_title, "\";'>", title, "</span>"),
      subtitle = paste0("<span style='font-family:\"", settings$font_body, "\";'>", subtitle, "</span>"),
...
# 5. Estilo Claude Monet
# Inspiración: Impresionismo, luz difuminada, colores suaves, naturaleza.
...
#' @importFrom grDevices colorRampPalette
#' @export
style_monet <- function(data, x, y, color_var = NULL, fill_var = NULL,
  ...
  p + ggplot2::theme_minimal() +
    ggplot2::theme(
      ...
      plot.margin = ggplot2::unit(c(1.5, 1.5, 1.5, 1.5), "cm"),
      panel.background = if (!show_background) ggplot2::element_blank() else ggplot2::element_rect(fill = settings$panel_fill, colour = NA),
      plot.background = ggplot2::element_rect(fill = settings$background_fill, colour = NA), # Always show plot background
      axis.text = ggplot2::element_text(size = 12, color = settings$text_color, family = settings$font_body),
      axis.title = ggtext::element_markdown(size = 15, color = settings$text_color, family = settings$font_body),
      panel.grid.major = if (add_grid_lines) ggplot2::element_line(color = settings$grid_color, linetype = "solid", linewidth = 0.3) else ggplot2::element_blank(),
      panel.grid.minor = ggplot2::element_blank()
...
# 6. Estilo Banksy
# Inspiración: Estilo stencil, blanco y negro, toques de color, mensajes sociales.
...
#' @importFrom tools toTitleCase
#' @export
style_banksy <- function(data, x, y, color_var = NULL, fill_var = NULL,
  ...
  settings <- list(
    "girl_with_balloon" = list(
      ...
      font_title = "Permanent Marker", font_body = "Cabin Sketch",
      background_fill = "#D3D3D3", panel_fill = "#A9A9A9",
  ...
  if (plot_type == "scatter") {
    p <- p + ggplot2::geom_point(ggplot2::aes_string(color = color_var %||% "NULL"), size = 4, alpha = settings$geom_alpha,
                                 color = if (is.null(color_var)) settings$colors[1] else ggplot2::aes_string(color = color_var))
  } else if (plot_type == "line") {
    p <- p + ggplot2::geom_line(ggplot2::aes_string(color = color_var %||% "NULL"), size = 1.5, alpha = settings$geom_alpha, linetype = "dashed",
                                color = if (is.null(color_var)) settings$colors[1] else ggplot2::aes_string(color = color_var)) +
      ggplot2::geom_point(ggplot2::aes_string(color = color_var %||% "NULL"), size = 3, alpha = settings$geom_alpha,
                          color = if (is.null(color_var)) settings$colors[1] else ggplot2::aes_string(color = color_var))
  } else if (plot_type == "column") {
    data[[x]] <- factor(data[[x]])
    p <- p + ggplot2::geom_col(ggplot2::aes_string(fill = fill_var %||% "NULL"), width = 0.8, alpha = settings$geom_alpha,
                               fill = if (is.null(fill_var)) settings$colors[1] else ggplot2::aes_string(fill = fill_var))
  }
  ...
  p + ggplot2::theme_void() +
    ggplot2::theme(
      ...
      axis.text = ggplot2::element_text(size = 12, color = settings$text_color, family = settings$font_body),
      axis.title = ggtext::element_markdown(size = 15, color = settings$text_color, family = settings$font_body),
      panel.grid.major = if (add_grid_lines) ggplot2::element_line(color = settings$grid_color, linetype = "solid", linewidth = 0.5) else ggplot2::element_blank(),
      panel.grid.minor = ggplot2::element_blank(),
      axis.line = ggplot2::element_line(color = settings$grid_color, linewidth = 0.5)
    ) +
    ggplot2::labs(
...
# 7. Estilo Salvador Dalí
# Inspiración: Surrealismo, colores a menudo cálidos/fríos y contrastantes, formas distorsionadas, elementos oníricos.
...
#' @param show_labels Logical, whether to show data labels. Defaults to FALSE.
#' @param add_glow Logical, whether to add an outer glow effect. Defaults to FALSE.
#' @param add_jitter Logical, whether to add a jitter effect to scatter points. Defaults to FALSE.
#' @param add_grid_lines Logical, whether to show major grid lines. Defaults to FALSE.
#' @param show_background Logical, whether to show the panel background. Defaults to TRUE.
#' @return A ggplot2 object.
...
#' @importFrom tools toTitleCase
#' @export
style_salvador_dali <- function(data, x, y, color_var = NULL, fill_var = NULL,
  ...
  if (plot_type == "scatter") {
    ...
    if (add_jitter) {
      p <- p + ggplot2::geom_jitter(width = 0.1, height = 0.1, alpha = settings$geom_alpha * 0.3, color = settings$text_color) # Efecto de "derretido"
    }
  } else if (plot_type == "line") {
    line_params <- list(
      size = 1.5,
  ...
  p + ggplot2::theme_dark() +
    ggplot2::theme(
      ...
      axis.text = ggplot2::element_text(size = 12, color = settings$text_color, family = settings$font_body),
      axis.title = ggtext::element_markdown(size = 15, color = settings$text_color, family = settings$font_body),
      panel.grid.major = if (add_grid_lines) ggplot2::element_line(color = settings$grid_color, linetype = "dashed", linewidth = 0.4) else ggplot2::element_blank(),
      panel.grid.minor = ggplot2::element_blank(),
      axis.line = ggplot2::element_line(color = settings$grid_color, linewidth = 0.5)
    ) +
    ggplot2::labs(
...
# 8. Estilo Joan Miró
# Inspiración: Formas orgánicas, colores primarios y vibrantes, líneas negras y puntos, simbolismo.
...
#' @importFrom tools toTitleCase
#' @export
style_miro <- function(data, x, y, color_var = NULL, fill_var = NULL,
...
# 9. Estilo Artemisia Gentileschi
# Inspiración: Barroco, claroscuro dramático, colores ricos y profundos, figuras fuertes.
...
#' @importFrom tools toTitleCase
#' @export
style_artemisia_gentileschi <- function(data, x, y, color_var = NULL, fill_var = NULL,
...
# 10. Estilo Wassily Kandinsky
# Inspiración: Abstracción, formas geométricas y orgánicas, colores vibrantes en composiciones dinámicas.
...
#' @importFrom sysfonts font_add_google
#' @export
style_kandinsky <- function(data, x, y, color_var = NULL, fill_var = NULL,
  ...
  # Carga de fuentes (idealmente, se hace una vez con load_all_artist_fonts() al inicio de la sesión)
  sysfonts::font_add_google("Oswald", "Oswald")
  sysfonts::font_add_google("Bebas Neue", "Bebas Neue")
  sysfonts::font_add_google("Lato", "Lato")
  showtext::showtext_auto()
...
# 11. Estilo Andy Warhol
# Inspiración: Pop Art, colores planos y contrastantes, repetición, imágenes icónicas.
...
#' @importFrom tools toTitleCase
#' @export
style_andy_warhol <- function(data, x, y, color_var = NULL, fill_var = NULL,
